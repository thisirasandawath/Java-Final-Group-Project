...
<div class="admin-container" id="welcome">
    <div class="admin-items">
        ...
        <div class="admin-buttons">
            ...
            <div><a href="./add-chef"><button>Add Chefs</button></a></div>
            <div><a href="./manage-chef"><button>Manage Chefs</button></a></div>
            <div><a href="./add-helper"><button>Add Helpers</button></a></div>
            <div><a href="./manage-helper"><button>Manage Helpers</button></a></div>
        </div>
    </div>
</div>
